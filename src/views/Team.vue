          ...
          <div class="col-12 col-md-6 col-lg-3">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">
                  {{ lang["descriptionAmparo"] }}
                </p>
                <a
                  href="https://www.linkedin.com/in/amparocabezas-desarrolladora-web-frontend/"
                  target="_blank"
                  class="btn btn-primary"
                  ><i class="fab fa-linkedin"></i
                ></a>
                <a
                  href="https://github.com/Amparcabezas"
                  class="btn btn-primary"
                  target="_blank"
          ...
          <div class="col-12 col-md-6 col-lg-3">
            <div class="card">
              ...
              <div class="card-body">
                ...
                ></a>
                <a
                  href="https://github.com/nurimartinez"
                  class="btn btn-primary"
                  target="_blank"
                  ><i class="fab fa-github-square"></i
                ></a>
          ...
          <div class="col-12 col-md-6 col-lg-3">
            <div class="card">
              ...
              <div class="card-body">
                ...
                ></a>
                <a
                  href="https://github.com/belopmardev"
                  class="btn btn-primary"
                  target="_blank"
                  ><i class="fab fa-github-square"></i
                ></a>
